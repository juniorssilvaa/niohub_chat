...
urlpatterns = [
    ...
    path('webhooks/admin/provider-status/', csrf_exempt(views.AdminProviderStatusWebhookView.as_view()), name='webhook-admin-provider-status'),
    ...
    path('tenant-context/', views.tenant_context_view, name='tenant-context'),
